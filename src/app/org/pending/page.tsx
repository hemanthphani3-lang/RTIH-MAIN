export default function PendingApproval() {
  return (
    <div className="min-h-screen relative flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 w-full max-w-lg text-center space-y-6 bg-white dark:bg-white/5 backdrop-blur-md rounded-[2rem] shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] border border-slate-300 dark:border-white/20 p-10 text-slate-900 dark:text-white">
        ...
        <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-2">Application Submitted!</h1>
