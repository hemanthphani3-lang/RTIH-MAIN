      ...
      <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500 pb-20">
        <div className="flex items-center justify-between bg-white dark:bg-white/5 backdrop-blur-xl border border-slate-200 dark:border-white/10 p-6 rounded-3xl">
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-1 text-sm">Statewide Ecosystem Intelligence and Innovation Analytics.</p>
          </div>
        </div>

        {/* Top KPI Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white dark:bg-white/5 backdrop-blur-xl p-6 rounded-3xl border border-slate-200 dark:border-white/10 flex items-center justify-between hover:bg-white/60 dark:bg-white/10 transition-colors">
            <div>
              <p className="text-sm font-bold text-slate-600 dark:text-slate-300 uppercase tracking-widest">Total Organizations</p>
          ...
          <div className="bg-white dark:bg-white/5 backdrop-blur-xl p-6 rounded-3xl border border-slate-200 dark:border-white/10 flex items-center justify-between hover:bg-white/60 dark:bg-white/10 transition-colors">
            <div>
              <p className="text-sm font-bold text-slate-600 dark:text-slate-300 uppercase tracking-widest">Active Startups</p>
          ...
          <div className="bg-white dark:bg-white/5 backdrop-blur-xl p-6 rounded-3xl border border-slate-200 dark:border-white/10 flex items-center justify-between hover:bg-white/60 dark:bg-white/10 transition-colors">
            <div>
              <p className="text-sm font-bold text-slate-600 dark:text-slate-300 uppercase tracking-widest">Graduated</p>
          ...
          <div className="bg-white dark:bg-white/5 backdrop-blur-xl p-6 rounded-3xl border border-slate-200 dark:border-white/10 flex items-center justify-between hover:bg-white/60 dark:bg-white/10 transition-colors">
            <div>
              <p className="text-sm font-bold text-slate-600 dark:text-slate-300 uppercase tracking-widest">Active Mentors</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
          <div className="bg-white dark:bg-white/5 backdrop-blur-xl rounded-3xl border border-slate-200 dark:border-white/10 p-6 h-80 flex flex-col relative group">
            ...
            {!selectedHub && <p className="absolute top-16 left-6 text-xs text-slate-500 dark:text-slate-400 z-10 hidden group-hover:block">Click a bar to view domains</p>}
          ...
          <div className="bg-white dark:bg-white/5 backdrop-blur-xl rounded-3xl border border-slate-200 dark:border-white/10 p-6 h-80 flex flex-col">
            <h3 className="font-extrabold text-lg text-slate-900 dark:text-white mb-6 flex items-center gap-2"><CheckCircle className="w-5 h-5 text-purple-400" /> Startup Funnel (Stage)</h3>
            <div className="flex-1 min-h-0">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
